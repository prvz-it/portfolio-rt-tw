...
import ResumeReusableCen from "./reusable/ResumeReusableCen";
              ...
              <div className="xl:mt-20 mt-40 xl:w-[67%] w-full mx-auto">
                <div className="md:flex items-center justify-between relative">
                  ...
                  <div className="lg:mr-12 md:mr-3 mr-0">
                      ...
                      <ResumeReusableCen numberTx="2022 - 2024" headerTx="ReactJS Developer" text="I entered the Creative It Institute this time to learn React JS. It required a great deal of effort."/>
                  ...
                  <div className="absolute xl:top-[43%] md:top-[-16%] sm:top-[-7.5%] top-[-8%] xl:left-[-23.5%] md:left-[14%] sm:left-[38%] left-[30%]">
                  ...
                  <div className="xl:w-[49.9%] lg:ml-12 md:ml-3 md:mt-0 mt-[160px]">
                    ...
                    <ResumeReusableCen numberTx="2023 - 2024" headerTx="Junior-Ex Developer" text="I performed well at work. They were equal to me since I executed their work perfectly. prvz"/>
                  ...
                  <div className="absolute xl:top-[43%] md:top-[-16%] sm:top-[48%] top-[47.7%] xl:right-[-23.5%] md:right-[13%] sm:right-[37%] right-[30%]">
