                ...
                <Container>
                    <MarginX className="lg:h-screen lg:flex lg:items-center">
                        <div className="lg:w-1/2 lg:text-left text-center">
                            <h2 className='font-playFair font-black lg:text-[62px] text-[48px] text-Main_Hv mb-1'>Hello</h2>
                            <h1 className='font-playFair font-bold xl:text-[84px] lg:text-[62px] text-[60px] text-Main_Hv duration-500 mb-4'>I'm <span className='relative z-0 before:absolute before:content[""] lg:before:bottom-[12px] before:bottom-[8px] before:left-[0px] before:w-full before:h-[10px] before:bg-[#b7b7b7] before:rounded-lg before:-z-10'>Parvez</span></h1>
