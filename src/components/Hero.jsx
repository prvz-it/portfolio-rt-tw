...
import heroImage from "../assets/prvz-hero.png";
        ...
        <div className="bg-[url('../src/assets/bg01.png'),_url('../src/assets/bg02.png')] bg-no-repeat bg-center bg-cover">
          <Container>
            <MarginX className="lg:h-screen lg:flex lg:items-center">
              <div className="lg:w-2/5 lg:text-left text-center">
                <h2 className="font-playFair font-black lg:text-[62px] text-[48px] max-[350px]:text-[40px] text-Main_Hv mb-1">
                  Hello
                </h2>
                <h1 className="font-playFair font-bold xl:text-[84px] lg:text-[62px] text-[60px] max-[350px]:text-[48px] text-Main_Hv duration-500 mb-4">
                  I'm{" "}
                ...
                <span className=" font-Space font-medium lg:text-[21px] sm:text-[22px] text-[20px] text-Main tracking-wider">
                  <Typewriter
                    words={[
                      "A Frontend Developer",
                      "I Develop with ReactJS",
                      "I Develop with Sass & Tailwind",
                    ]}
                    loop={5}
                    cursor
                    cursorStyle="|"
            ...
            <div className="lg:block hidden lg:mx-6 mx-0">
              <div className="h-1/2 absolute content[''] right-[0%] xl:top-[25%] lg:top-[28%]">
                <div className="h-full flex flex-col justify-around items-center">
                  <div className="">
                    <a
                      className="rotate-90 font-Montserrat font-bold text-[16px] uppercase text-[#292929] hover:text-[#000]"
                      href="https://www.facebook.com/prvz.it" target="blank"
                    >
                      {" "}
                      Facebook{" "}
                    </a>
                  ...
                  <div className="">
                    <a
                      className="rotate-90  font-Montserrat font-bold text-[16px] uppercase text-[#292929] hover:text-[#000]"
                      href="https://twitter.com/prvz_it"
                      target="blank"
                    >
                      {" "}
                      Twitter{" "}
                  ...
                  <div className="">
                    <a
                      className=" rotate-90 font-Montserrat font-bold text-[16px] uppercase text-[#292929] hover:text-[#000]"
                      href="https://www.linkedin.com/in/prvz-it"
                      target="blank"
                    >
                      {" "}
                      Linkedin{" "}
